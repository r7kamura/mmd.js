(function() {
  ...
  MMD.MotionParser = (function() {
    ...
    MotionParser.prototype.int8 = function() {
      this.index += 1;
      return this.dataView.getInt8(this.index - 1, true);
    };

    MotionParser.prototype.int16 = function() {
      this.index += 2;
      return this.dataView.getInt16(this.index - 2, true);
    };

    MotionParser.prototype.int32 = function() {
      this.index += 4;
      return this.dataView.getInt32(this.index - 4, true);
    };
    ...
    MotionParser.prototype.uint16 = function() {
      this.index += 2;
      return this.dataView.getUint16(this.index - 2, true);
    };
    ...
    MotionParser.prototype.string = function(size) {
      return this.chars(size).join('');
    };
    ...
    MotionParser.prototype.rgba = function() {
      return {
        r: this.float(),
        g: this.float(),
        b: this.float(),
    ...
    MotionParser.prototype.frame = function() {
      return {
        name: this.string(15),
        index: this.uint32(),
        position: this.xyz(),
